...
import org.span.service.routing.AodvProtocol;
...
public class ManetServiceHelper {
	...
	private RoutingProtocol createRoutingProtocol() {
		...
		} else if (manetcfg.getRoutingProtocol().equals(AodvProtocol.NAME)) {
			return new AodvProtocol();
		} else {
			return null;
		}
	}
    ...
    */
	...
	private void installFiles() {
		...
		// aodvd
		if (message == null){
			message = copyFile(CoreTask.DATA_FILE_PATH + "/bin/aodvd", "0755", R.raw.aodvd);
		}
		// kaodv.ko
		if (message == null){
			message = copyFile(CoreTask.DATA_FILE_PATH + "/bin/kaodv.ko", "0755", R.raw.kaodv_ko);
		}
